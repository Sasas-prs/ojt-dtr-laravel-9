...
Route::middleware('auth')->group(function () {
    ...
    //dtr page
    Route::get('/dtr-view/{id}', [DtrSummaryController::class, 'showUserRequestedDtr'])->name('users.dtr.view');

    Route::get('/admin/dtr-view/{id}/{month}/{year}/{type}', [DtrSummaryController::class, 'showAdminUserRequestedDtr'])->name('admin.users.dtr.view');
