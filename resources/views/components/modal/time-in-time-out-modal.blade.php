        ...
        <div
            ...
            <div class="flex flex-col items-center w-full p-10 gap-5 bg-white rounded-2xl">
                ...
                <div class="grid grid-cols-2 gap-4 w-full">
                    ...
                    @endforeach --}}
                    <section class="p-4 border border-gray-200 bg-white rounded-lg w-full">
                        <h1 class="text-sm text-custom-red font-semibold">Student No.</h1>
                        <span class="w-full flex justify-end">
                            <h1 class="text-lg text-black" name="student_no">student_no_placeholder</h1>
                        </span>
                    </section>
                    <section class="p-4 border border-gray-200 bg-white rounded-lg w-full">
                        <h1 class="text-sm text-custom-red font-semibold">Phone</h1>
                        <span class="w-full flex justify-end">
                            <h1 class="text-lg text-black" name="phone">phone_placeholder</h1>
                        </span>
                    </section>
                    <section class="p-4 border border-gray-200 bg-white rounded-lg w-full">
                        <h1 class="text-sm text-custom-red font-semibold">QR Code</h1>
                        <span class="w-full flex justify-end">
                            <h1 class="text-lg text-black" name="qr_code">qr_code_placeholder</h1>
                        </span>
                    </section>
                    <section class="p-4 border border-gray-200 bg-white rounded-lg w-full">
                        <h1 class="text-sm text-custom-red font-semibold">Total Hours</h1>
                        <span class="w-full flex justify-end">
                            <h1 class="text-lg text-black" name="total_hours">total_hours_placeholder</h1>
                        </span>
                    </section>
                </div>
